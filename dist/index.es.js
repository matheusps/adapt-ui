import React, { cloneElement, createContext, createElement, Component, useContext, useState } from 'react';
...
var Clickable = function (_a) {
    var full = _a.full, disabled = _a.disabled, onClick = _a.onClick, as = _a.as, rest = __rest(_a, ["full", "disabled", "onClick", "as"]);
    var handleClickEvent = function (e) {
        e.preventDefault();
        onClick && onClick(e);
    };
    return (React.createElement(StyledBox, __assign({ as: as, full: full, disabled: disabled, onClick: handleClickEvent }, rest)));
};
...
var Flexible = styled(Box)(function (props) { return ({
    width: props.width,
    height: props.height,
    order: props.order,
...
var Scrollable = styled(Box)(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  ", ";\n"], ["\n  ",
    ";\n"])), function (_a) {
    var axis = _a.axis;
...
var H1 = styled.h1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  font-size: 4rem;\n  font-weight: 400;\n  margin: 0.67em 0;\n"], ["\n  font-size: 4rem;\n  font-weight: 400;\n  margin: 0.67em 0;\n"])));
...
var getComponent = function (level) {
    switch (level) {
        case 1:
            return H1;
        case 2:
...
var Heading = function (_a) {
    var _b = _a.level, level = _b === void 0 ? 1 : _b, props = __rest(_a, ["level"]);
    var Component = getComponent(level);
    //@ts-ignore
...
var getMeasure = function (measure, _a) {
    var sm = _a[0], md = _a[1], lg = _a[2], xl = _a[3];
    switch (measure) {
        case 'sm':
            return sm;
        case 'md':
...
var infiniteSpin = keyframes(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  from {transform: rotate(0deg)}\n  to {transform: rotate(360deg)}\n"], ["\n  from {transform: rotate(0deg)}\n  to {transform: rotate(360deg)}\n"])));
var getSpeed = function (speed) {
    return speed === 'fast' ? 600 : speed === 'slow' ? 900 : 750;
};
var getThickness = function (thickness) {
    return getMeasure(thickness, [2, 4, 6, 7]);
};
var getSize = function (size) {
    return typeof size === 'number' ? size : getMeasure(size, [1.5, 2, 3, 4]);
};
var getGap = function (gap) { return getMeasure(gap, [1.5, 2, 3, 4]); };
var StyledSvg = styled.svg(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  transition-property: transform;\n  animation-name: ", ";\n  animation-iteration-count: infinite;\n  animation-timing-function: linear;\n"], ["\n  transition-property: transform;\n  animation-name: ", ";\n  animation-iteration-count: infinite;\n  animation-timing-function: linear;\n"])), infiniteSpin);
var Spinner = function (_a) {
    var thickness = _a.thickness, size = _a.size, speed = _a.speed, gap = _a.gap;
    return (React.createElement(StyledSvg, { height: getSize(size) + "rem", width: getSize(size) + "rem", style: { animationDuration: getSpeed(speed) + "ms" }, role: "img", viewBox: "0 0 32 32" },
        React.createElement("circle", { role: "presentation", cx: 16, cy: 16, stroke: 'black', r: 14 - getThickness(thickness) / 2, fill: "none", strokeWidth: getThickness(thickness), strokeDasharray: Math.PI * 2 * (11 - getGap(gap)), strokeLinecap: "round" })));
};
...
var getFontSize = function (measure) {
    return getMeasure(measure, [0.8, 1, 1.25, 1.5]);
};
var getPadding = function (measure) {
...
var StyledClickable = styled(Clickable)(function (_a) {
    var fontSize = _a.fontSize, padding = _a.padding;
    return ({
        fontSize: fontSize,
        padding: padding,
    });
...
var Button = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 'md' : _b, _c = _a.loading, loading = _c === void 0 ? false : _c, children = _a.children, props = __rest(_a, ["size", "loading", "children"]);
    var fontSize = getFontSize(size) + "rem";
    var padding = getPadding(size);
    return (React.createElement(StyledClickable, __assign({ fontSize: fontSize, padding: padding }, props), loading ? React.createElement(Spinner, { size: getFontSize(size) }) : children));
};

var TabsContext = React.createContext(null);
var Provider = TabsContext.Provider;

var Tabs = function (_a) {
    var activeTab = _a.activeTab, onTabClick = _a.onTabClick, children = _a.children;
...
var Tab = function (_a) {
    ...
    var _b = useContext(TabsContext), activeTab = _b.activeTab, onTabClick = _b.onTabClick;
    var handleClick = function () {
        onTabClick(id);
    };
    return React.createElement(Clickable, { onClick: handleClick }, label);
};

var useTabState = function (initalTab) {
    var _a = useState(initalTab), activeTab = _a[0], setActiveTab = _a[1];
    var onTabClick = function (id) {
        setActiveTab(id);
    };
    return {
        activeTab: activeTab,
...
var useTheme = function () {
    ...
    return __assign({}, theme);
};

export { AdaptProvider, Box, Button, Clickable, Flexible, Heading, Input, Label, Paragraph, Scrollable, Spinner, Tab, Tabs, TypoPreflight, useTabState, useTheme };
