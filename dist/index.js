...
var Clickable = function (_a) {
    ...
    return (React__default.createElement(StyledBox, __assign({ as: as, full: full, disabled: disabled, onClick: handleClickEvent }, rest)));
};
...
var AdaptProvider = function (_a) {
    ...
    return (React__default.createElement(ThemeProvider, { theme: theme },
        React__default.createElement(React__default.Fragment, null,
            React__default.createElement(GlobalStyle$1, null),
            React__default.createElement(TypoPreflight, null),
            children)));
};
...
var Spinner = function (_a) {
    ...
    return (React__default.createElement(StyledSvg, { height: getSize(size) + "rem", width: getSize(size) + "rem", style: { animationDuration: getSpeed(speed) + "ms" }, role: "img", viewBox: "0 0 32 32" },
        React__default.createElement("circle", { role: "presentation", cx: 16, cy: 16, stroke: 'black', r: 14 - getThickness(thickness) / 2, fill: "none", strokeWidth: getThickness(thickness), strokeDasharray: Math.PI * 2 * (11 - getGap(gap)), strokeLinecap: "round" })));
};
...
var Button = function (_a) {
    ...
    return (React__default.createElement(StyledClickable, __assign({ fontSize: fontSize, padding: padding }, props), loading ? React__default.createElement(Spinner, { size: getFontSize(size) }) : children));
};

var TabsContext = React__default.createContext(null);
...
var Tabs = function (_a) {
    ...
    return (React__default.createElement(Box, { width: "100%" },
        React__default.createElement(Provider, { value: {
                activeTab: activeTab,
...
var Tab = function (_a) {
    ...
    var _b = React.useContext(TabsContext), activeTab = _b.activeTab, onTabClick = _b.onTabClick;
    var handleClick = function () {
        onTabClick(id);
    };
    return React__default.createElement(Clickable, { onClick: handleClick }, label);
};

var useTabState = function (initalTab) {
    var _a = React.useState(initalTab), activeTab = _a[0], setActiveTab = _a[1];
